...
type MockLinkRepository struct {
	...
	GetByUserIDAndSlugFunc     func(userID uuid.UUID, slug string) (*models.Link, error)
...
func (m *MockLinkRepository) GetByUserIDAndSlug(userID uuid.UUID, slug string) (*models.Link, error) {
	return m.GetByUserIDAndSlugFunc(userID, slug)
}
